...
<body>
	...
	<div class="container">
			<table class="table table-striped">
				<thead>
					<tr>
						<th><h3><center>FORM EDIT DATA BUS</center></h3></th>
					</tr>
				</thead>
				<tbody>
					<tr class="info">
        ...
        <div class="control-group">
			...
			<div class="controls">
				<input type="text" name="kode" disabled value="<?php echo $row['kode']; ?>" size="50"/>
			</div>
        </div>
		<div class="control-group">
		...
		<div class="control-group">
			<div class="controls">
				...
				<a href="jadwal2.php"><button type="button" class="btn btn-danger" name="button">Kembali</button></a> <!-- kembali ke halaman matakuliah-->
			</div> 
        </div>
        </form>	
						</td>
	...
	<?php
		...
		if(isset($_POST['submit'])){
			...
			$queryupdate2 = "UPDATE bus SET po='$po', jurusan='$jurusan', kelas='$kelas', jadwal='$jadwal', fasilitas='$fasilitas', hargajual='$hargajual' WHERE kode='$kode'"; /* querry sql untuk mengupdate data sesuai dengan nim */
			
			if (mysqli_query($koneksi, $queryupdate2)){
				echo "data has been updated succesfully";
				header("Location: jadwal2.php");
			}else{
				echo "error: ". $queryupdate2 . "<br/>". mysqli_error($koneksi);
			}
